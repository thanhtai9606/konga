(function () {
    ...
    angular.module('frontend.services').controller('ServicesController', [
        '$scope',
        '$rootScope',
        '$log',
        '$state',
        ...
        function controller(
            ...
            $scope = angular.extend(
                $scope,
                angular.copy(ListConfig.getConfig('service', ServiceModel))
            );
            ...
            function isRequestPathOrUriStripped(service) {
                if (
                    $rootScope.Gateway &&
                    $rootScope.Gateway.version.indexOf('0.9.') > -1
                ) {
